export const abilities = {
  ...
  // Lacadia
  "Parasitoid": { description: "This Pokemon heals 25% of the damage dealt with direct attacks.", tag: "lacadia" },
  "Ancient Guard": { description: "Rock-type moves are not very effective against this Pokemon and it is also immune to Stealth Rock.", tag: "lacadia" },
  "Pollyanna": { description: "Raises this Pokémon's HP when hit by a Dark-type move, instead of taking damage.", tag: "lacadia" },
  "Overload": { description: "This Pokemon skips charge and recharge turns for moves.", tag: "lacadia" },
  "Stoicism": { description: "This Pokemon is immune to attack drops, burns, and flinches.", tag: "lacadia" },
  "Lockdown": { description: "This Pokemon is immune to pivot moves and blocks switch effects.", tag: "lacadia" },
  "Withering": { description: "Prevents all Pokemon from restoring health.", tag: "lacadia" },
  "Verdant Hunger": { description: "The power of draining moves and Leech Seed is doubled.", tag: "lacadia" },
  "Polarity": { description: "This Pokemon's Fire-type moves become slightly more powerful in snow, and its Ice-type moves become slightly more powerful in harsh sunlight.", tag: "lacadia" },
  "Noble Bearing": { description: "Boosts defense, special defense, and speed when this Pokemon successfully inflicts a status condition.", tag: "lacadia" },
  ...
  "Ruthless": { description: "This Pokemon's attacks always result in critical hits when the opponent has lowered stats.", tag: "lacadia" },
  "Malodorous": { description: "When this Pokemon is knocked out in battle, the opposing Pokemon has its stats lowered by one stage.", tag: "lacadia" },
  "Schrödinger": { description: "This Pokemon's normal type moves become ghost type, and vice versa.", tag: "lacadia" },
  "Surveil": { description: "When it enters a battle, the Pokémon can tell the speed stat of the opposing Pokémon.", tag: "lacadia" },
  "Backstabber": { description: "This Pokemon's attack moves will always hit a target first if that target is switching out of battle.", tag: "lacadia" },
  "Meltdown": { description: "This Pokemon will use the move Eruption immediately after being hit by a Fire-type move.", tag: "lacadia" },
  "Metal Eater": { description: "This Pokemon's moves become 30% more powerful when a Steel-type Pokemon is on the field.", tag: "lacadia" },
  "Momentum": { description: "This Pokemon's attack moves become more powerful each time they are used consecutively.", tag: "lacadia" },
  "Hunter's Instincts": { description: "When this Pokemon or an opposing Pokemon enters the battle, the Pokemon reveals whether the opponent can be knocked out in one hit.", tag: "lacadia" },
  "Abrasive": { description: "When it enters battle, this Pokemon deals damage equal to one-eighth of the enemy's max HP.", tag: "lacadia" },
  "Lucky Star": { description: "This Pokemon's moves have a doubled chance of triggering secondary effects, while the opponent's moves have a half chance of triggering secondary effects on the user.", tag: "lacadia" },
  "Aspect Twist": { description: "This Pokemon's Physical moves use its Sp. Atk stat, while Special moves use the Atk stat.", tag: "lacadia" },
  "Brain Jack": { description: "This Pokemon's Psychic-type moves have a 50% chance of inflicting confusion, infatuation, disable, encore, or torment.", tag: "lacadia" },
  "Flightless": { description: "Powers up Flying-type moves.", tag: "lacadia" },
  "Life Aurora": { description: "Whenever an opposing Pokemon restores health, this Pokemon restores the same amount of health.", tag: "lacadia" },
