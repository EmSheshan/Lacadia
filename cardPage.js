...
function displaySelectedPokemon(formIndex = 0) {
    ...
    const sigmovedesc = moves[sigmove] ? `
        ${moves[sigmove].type ? `<img src="typeIcons/${moves[sigmove].type}.png" style="width:1.8rem;height:1.8rem;vertical-align:middle;">` : ''}
        ${moves[sigmove].category ? `<img src="moveIcons/${moves[sigmove].category}.png" style="width:1.8rem;height:1.8rem;vertical-align:middle;">` : ''}
    ...
    document.getElementById("pokemonTitleTypeContainer").innerHTML = `
        <div class="title-type-container">
            <h2>#${pokemonNumber - 1999} ${displayName}</h2>
    ...
    document.getElementById("pokemonCardLeft").innerHTML = `
        <div class="pokemon-images-container">
            <div class="circle-background">
                <img src="${regularImage}" class="pokemon-image-large" id="pokemonMainImage" onerror="this.src='${errorImage}'"/>
            </div>
        </div>
